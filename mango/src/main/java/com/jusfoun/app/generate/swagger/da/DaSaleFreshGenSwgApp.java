...
import com.jusfoun.bll.extend.split.da.DaSaleFreshSplBll;
import com.jusfoun.bll.extend.unity.da.DaSaleFreshUntBll;
import com.jusfoun.ent.extend.da.DaSaleFresh;
import com.jusfoun.ent.custom.ResultModel;
import com.jusfoun.ent.parameter.da.DaSaleFreshParameter;
 ...
 * @description 鲜果销售数据表 对外接口，扩展自BaseSwgApp，自动生成。
 */

@Api(value = "DaSaleFresh",tags="鲜果销售数据表")
@RequestMapping(value = "/generate/swagger/da/daSaleFresh")
public class DaSaleFreshGenSwgApp extends BaseSwgApp {
	...
	@Autowired
	@Qualifier("daSaleFreshSplBll")
	protected DaSaleFreshSplBll daSaleFreshSplBll;
	...
	public ResultModel add(@RequestBody DaSaleFresh jsonData) {
		ResultModel result = daSaleFreshUntBll.add(jsonData);
	...
	public ResultModel addList(@RequestBody DaSaleFreshParameter.AddList jsonData) {
		ResultModel result = daSaleFreshUntBll.add(jsonData.getEntityList());
	...
	public ResultModel delete(@RequestParam String id) {
		ResultModel result = daSaleFreshUntBll.delete(id);
	...
	public ResultModel deleteList(@RequestBody DaSaleFreshParameter.DeleteByIdList jsonData) {
		ResultModel result = daSaleFreshUntBll.deleteByIdList(jsonData.getIdList());
	...
	public ResultModel update(@RequestBody DaSaleFresh jsonData) {
		ResultModel result = daSaleFreshUntBll.update(jsonData);
	...
	public ResultModel updateList(@RequestBody DaSaleFreshParameter.UpdateList jsonData) {
		ResultModel result = daSaleFreshUntBll.updateList(jsonData);
    ...
    public ResultModel updateListWithDff(@RequestBody DaSaleFreshParameter.AddList jsonData) {
		ResultModel result = daSaleFreshUntBll.updateListWithDff(jsonData.getEntityList());
    ...
    public ResultModel updateListWithDffOrAdd(@RequestBody DaSaleFreshParameter.AddList jsonData) {
		ResultModel result = daSaleFreshUntBll.updateListWithDffOrAdd(jsonData.getEntityList());
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，查询参数", required = true, dataType = "DaSaleFreshGetList") })
	@RequestMapping(value = "/getList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel getList(@RequestBody DaSaleFreshParameter.GetList jsonData) {
		// 处理业务与返回数据
		ResultModel result = daSaleFreshUntBll.getList(jsonData);
	...
	public void exportExcel() {
		...
		String fileName = "鲜果销售数据表列表数据" + DateUtils.getCurrentDateStr() + ".xls";
		String jsonData = request.getParameter(SymbolicConstant.CONTROLLER_PARAM_JSON);
