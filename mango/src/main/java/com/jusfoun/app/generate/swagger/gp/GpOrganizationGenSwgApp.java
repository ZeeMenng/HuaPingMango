...
import com.jusfoun.bll.extend.split.gp.GpOrganizationSplBll;
import com.jusfoun.bll.extend.unity.gp.GpOrganizationUntBll;
import com.jusfoun.ent.extend.gp.GpOrganization;
import com.jusfoun.ent.custom.ResultModel;
import com.jusfoun.ent.parameter.gp.GpOrganizationParameter;
...
@Api(value = "GpOrganization",tags="")
@RequestMapping(value = "/generate/swagger/gp/gpOrganization")
public class GpOrganizationGenSwgApp extends BaseSwgApp {
	...
	@Autowired
	@Qualifier("gpOrganizationSplBll")
	protected GpOrganizationSplBll gpOrganizationSplBll;
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，对象列表", required = true, dataType = "GpOrganizationAddList") })
	@RequestMapping(value = "/addList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel addList(@RequestBody GpOrganizationParameter.AddList jsonData) {
		ResultModel result = gpOrganizationUntBll.add(jsonData.getEntityList());
	...
	public ResultModel delete(@RequestParam String id) {
		ResultModel result = gpOrganizationUntBll.delete(id);
	...
	@ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，主键列表", required = true, dataType = "GpOrganizationDeleteByIdList")
	@RequestMapping(value = "/deleteList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel deleteList(@RequestBody GpOrganizationParameter.DeleteByIdList jsonData) {
		ResultModel result = gpOrganizationUntBll.deleteByIdList(jsonData.getIdList());
    ...
    public ResultModel updateListWithDff(@RequestBody GpOrganizationParameter.AddList jsonData) {
		ResultModel result = gpOrganizationUntBll.updateListWithDff(jsonData.getEntityList());
    ...
    public ResultModel updateListWithDfforAdd(@RequestBody GpOrganizationParameter.AddList jsonData) {
		ResultModel result = gpOrganizationUntBll.updateListWithDffOrAdd(jsonData.getEntityList());
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，查询参数", required = true, dataType = "GpOrganizationGetList") })
	@RequestMapping(value = "/getList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel getList(@RequestBody GpOrganizationParameter.GetList jsonData) {
		// 处理业务与返回数据
		ResultModel result = gpOrganizationUntBll.getList(jsonData);
