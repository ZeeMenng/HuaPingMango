...
public class GpModuleGenSwgApp extends BaseSwgApp {
	...
	public ResultModel addList(@RequestBody GpModuleParameter.AddList jsonData) {
		ResultModel result = gpModuleUntBll.add(jsonData.getEntityList());
	...
	public ResultModel delete(@RequestParam String id) {
		ResultModel result = gpModuleUntBll.delete(id);
	...
	public ResultModel deleteList(@RequestBody GpModuleParameter.DeleteByIdList jsonData) {
		ResultModel result = gpModuleUntBll.deleteByIdList(jsonData.getIdList());
    ...
    public ResultModel updateListWithDff(@RequestBody GpModuleParameter.AddList jsonData) {
		ResultModel result = gpModuleUntBll.updateListWithDff(jsonData.getEntityList());
    ...
    public ResultModel updateListWithDfforAdd(@RequestBody GpModuleParameter.AddList jsonData) {
		ResultModel result = gpModuleUntBll.updateListWithDffOrAdd(jsonData.getEntityList());
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，查询参数", required = true, dataType = "GpModuleGetList") })
	@RequestMapping(value = "/getList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel getList(@RequestBody GpModuleParameter.GetList jsonData) {
		// 处理业务与返回数据
		ResultModel result = gpModuleUntBll.getList(jsonData);
