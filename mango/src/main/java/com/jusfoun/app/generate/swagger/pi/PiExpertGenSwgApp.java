...
import com.jusfoun.bll.extend.split.pi.PiExpertSplBll;
import com.jusfoun.bll.extend.unity.pi.PiExpertUntBll;
 ...
 * @description 专家表 对外接口，扩展自BaseSwgApp，自动生成。
 */

@Api(value = "PiExpert",tags="专家表")
@RequestMapping(value = "/generate/swagger/pi/piExpert")
public class PiExpertGenSwgApp extends BaseSwgApp {

	@Autowired
	@Qualifier("piExpertUntBll")
	protected PiExpertUntBll piExpertUntBll;

	@Autowired
	@Qualifier("piExpertSplBll")
	protected PiExpertSplBll piExpertSplBll;
	...
	public ResultModel add(@RequestBody PiExpert jsonData) {
		ResultModel result = piExpertUntBll.add(jsonData);

		return result;
	}

	@ApiOperation(value = "批量新增", notes = "新增多条记录")
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，对象列表", required = true, dataType = "PiExpertAddList") })
	@RequestMapping(value = "/addList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel addList(@RequestBody PiExpertParameter.AddList jsonData) {
		ResultModel result = piExpertUntBll.add(jsonData.getEntityList());
	...
	public ResultModel delete(@RequestParam String id) {
		ResultModel result = piExpertUntBll.delete(id);
	...
	@ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，主键列表", required = true, dataType = "PiExpertDeleteByIdList")
	@RequestMapping(value = "/deleteList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel deleteList(@RequestBody PiExpertParameter.DeleteByIdList jsonData) {
		ResultModel result = piExpertUntBll.deleteByIdList(jsonData.getIdList());
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，主键列表和要修改为的信息承载实体", required = true, dataType = "PiExpertUpdateList") })
	@RequestMapping(value = "/updateList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel updateList(@RequestBody PiExpertParameter.UpdateList jsonData) {
		ResultModel result = piExpertUntBll.updateList(jsonData);
    ...
    public ResultModel updateListWithDff(@RequestBody PiExpertParameter.AddList jsonData) {
		ResultModel result = piExpertUntBll.updateListWithDff(jsonData.getEntityList());
    ...
    public ResultModel updateListWithDffOrAdd(@RequestBody PiExpertParameter.AddList jsonData) {
		ResultModel result = piExpertUntBll.updateListWithDffOrAdd(jsonData.getEntityList());
	...
	public ResultModel getListByJsonData() {
		...
		selectBuffer.append("select A.id id,A.user_id userId,A.introduction introduction,A.is_recommend isRecommend  from pi_expert A inner join pi_expert B on A.id=B.id where 1=1 ");
	...
	public void exportExcel() {
		...
		String fileName = "专家表列表数据" + DateUtils.getCurrentDateStr() + ".xls";
		String jsonData = request.getParameter(SymbolicConstant.CONTROLLER_PARAM_JSON);
