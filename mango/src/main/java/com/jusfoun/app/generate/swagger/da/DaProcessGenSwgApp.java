...
import com.jusfoun.bll.extend.split.da.DaProcessSplBll;
import com.jusfoun.bll.extend.unity.da.DaProcessUntBll;
import com.jusfoun.ent.extend.da.DaProcess;
import com.jusfoun.ent.custom.ResultModel;
import com.jusfoun.ent.parameter.da.DaProcessParameter;
 ...
 * @description 加工品数据表 对外接口，扩展自BaseSwgApp，自动生成。
 */

@Api(value = "DaProcess",tags="加工品数据表")
@RequestMapping(value = "/generate/swagger/da/daProcess")
public class DaProcessGenSwgApp extends BaseSwgApp {

	@Autowired
	@Qualifier("daProcessUntBll")
	protected DaProcessUntBll daProcessUntBll;

	@Autowired
	@Qualifier("daProcessSplBll")
	protected DaProcessSplBll daProcessSplBll;
	...
	public ResultModel add(@RequestBody DaProcess jsonData) {
		ResultModel result = daProcessUntBll.add(jsonData);
	...
	public ResultModel addList(@RequestBody DaProcessParameter.AddList jsonData) {
		ResultModel result = daProcessUntBll.add(jsonData.getEntityList());
	...
	public ResultModel delete(@RequestParam String id) {
		ResultModel result = daProcessUntBll.delete(id);
	...
	public ResultModel deleteList(@RequestBody DaProcessParameter.DeleteByIdList jsonData) {
		ResultModel result = daProcessUntBll.deleteByIdList(jsonData.getIdList());
	...
	public ResultModel update(@RequestBody DaProcess jsonData) {
		ResultModel result = daProcessUntBll.update(jsonData);
	...
	public ResultModel updateList(@RequestBody DaProcessParameter.UpdateList jsonData) {
		ResultModel result = daProcessUntBll.updateList(jsonData);
    ...
    public ResultModel updateListWithDff(@RequestBody DaProcessParameter.AddList jsonData) {
		ResultModel result = daProcessUntBll.updateListWithDff(jsonData.getEntityList());
    ...
    public ResultModel updateListWithDffOrAdd(@RequestBody DaProcessParameter.AddList jsonData) {
		ResultModel result = daProcessUntBll.updateListWithDffOrAdd(jsonData.getEntityList());
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，查询参数", required = true, dataType = "DaProcessGetList") })
	@RequestMapping(value = "/getList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel getList(@RequestBody DaProcessParameter.GetList jsonData) {
		// 处理业务与返回数据
		ResultModel result = daProcessUntBll.getList(jsonData);
	...
	public void exportExcel() {
		...
		String fileName = "加工品数据表列表数据" + DateUtils.getCurrentDateStr() + ".xls";
		String jsonData = request.getParameter(SymbolicConstant.CONTROLLER_PARAM_JSON);
