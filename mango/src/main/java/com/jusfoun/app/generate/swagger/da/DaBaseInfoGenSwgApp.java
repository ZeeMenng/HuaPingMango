...
import com.jusfoun.bll.extend.split.da.DaBaseInfoSplBll;
import com.jusfoun.bll.extend.unity.da.DaBaseInfoUntBll;
import com.jusfoun.ent.extend.da.DaBaseInfo;
import com.jusfoun.ent.custom.ResultModel;
import com.jusfoun.ent.parameter.da.DaBaseInfoParameter;
 ...
 * @description 基地信息表 对外接口，扩展自BaseSwgApp，自动生成。
 */

@Api(value = "DaBaseInfo",tags="基地信息表")
@RequestMapping(value = "/generate/swagger/da/daBaseInfo")
public class DaBaseInfoGenSwgApp extends BaseSwgApp {
	...
	@Autowired
	@Qualifier("daBaseInfoSplBll")
	protected DaBaseInfoSplBll daBaseInfoSplBll;
	...
	public ResultModel add(@RequestBody DaBaseInfo jsonData) {
		ResultModel result = daBaseInfoUntBll.add(jsonData);
	...
	public ResultModel addList(@RequestBody DaBaseInfoParameter.AddList jsonData) {
		ResultModel result = daBaseInfoUntBll.add(jsonData.getEntityList());
	...
	public ResultModel delete(@RequestParam String id) {
		ResultModel result = daBaseInfoUntBll.delete(id);
	...
	public ResultModel deleteList(@RequestBody DaBaseInfoParameter.DeleteByIdList jsonData) {
		ResultModel result = daBaseInfoUntBll.deleteByIdList(jsonData.getIdList());
	...
	public ResultModel update(@RequestBody DaBaseInfo jsonData) {
		ResultModel result = daBaseInfoUntBll.update(jsonData);
	...
	public ResultModel updateList(@RequestBody DaBaseInfoParameter.UpdateList jsonData) {
		ResultModel result = daBaseInfoUntBll.updateList(jsonData);
    ...
    public ResultModel updateListWithDff(@RequestBody DaBaseInfoParameter.AddList jsonData) {
		ResultModel result = daBaseInfoUntBll.updateListWithDff(jsonData.getEntityList());
    ...
    public ResultModel updateListWithDffOrAdd(@RequestBody DaBaseInfoParameter.AddList jsonData) {
		ResultModel result = daBaseInfoUntBll.updateListWithDffOrAdd(jsonData.getEntityList());
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，查询参数", required = true, dataType = "DaBaseInfoGetList") })
	@RequestMapping(value = "/getList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel getList(@RequestBody DaBaseInfoParameter.GetList jsonData) {
		// 处理业务与返回数据
		ResultModel result = daBaseInfoUntBll.getList(jsonData);
	...
	public void exportExcel() {
		...
		String fileName = "基地信息表列表数据" + DateUtils.getCurrentDateStr() + ".xls";
		String jsonData = request.getParameter(SymbolicConstant.CONTROLLER_PARAM_JSON);
