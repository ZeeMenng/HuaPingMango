...
import com.jusfoun.app.generate.swagger.gp.GpRegionGenSwgApp;
import com.jusfoun.ent.custom.ResultModel;
import com.jusfoun.ent.extend.gp.GpRegion;
import com.jusfoun.ent.extend.gp.GpStation;
import com.jusfoun.ent.parameter.gp.GpRegionCountryParameter;
import com.jusfoun.ent.parameter.gp.GpRegionParameter;
...
public class GpRegionSwgApp extends GpRegionGenSwgApp {
	...
	public ResultModel updateList(@RequestBody GpRegionParameter.UpdateList jsonData) {
		...
		if((jsonData.getEntity().getCode().equals("")||jsonData.getEntity().getCode()==null)
				&&(jsonData.getEntity().getName().equals("")||jsonData.getEntity().getName()==null)
				&&(jsonData.getEntity().getCategory()==null)
				&&(jsonData.getEntity().getFartherCode().equals("")||jsonData.getEntity().getFartherCode()==null)
				&&(jsonData.getEntity().getIsDisplayCode()==null)
				&&(jsonData.getEntity().getRegionLevel()==null)
...
//		result.setData(dictionaryUtil.dictTransform(gpRegion));
		...
		List<Map<String, Object>> regionList = (List<Map<String, Object>>) resultModel.getData();
