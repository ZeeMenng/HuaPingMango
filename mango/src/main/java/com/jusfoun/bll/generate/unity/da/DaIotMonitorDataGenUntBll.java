...
import com.zee.dao.unity.da.IDaIotMonitorDataUntDal;
 ...
 * @description 物联网设备监控数据 业务逻辑处理类，扩展自BaseUntBll<DaIotMonitorData>，自动生成。
 */
public class DaIotMonitorDataGenUntBll extends BaseUntBll<DaIotMonitorData> {

	@Autowired
	protected IDaIotMonitorDataUntDal daIotMonitorDataUntDal;


	public ResultModel updateList(DaIotMonitorDataParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(DaIotMonitorDataParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(DaIotMonitorDataParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(DaIotMonitorDataParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			DaIotMonitorDataParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			DaIotMonitorDataParameter.GetList.Page page = getListParam.getPage();
			ArrayList<DaIotMonitorDataParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<DaIotMonitorData> list = baseUntDal.getList(map);
			PageInfo<DaIotMonitorData> pageInfo = new PageInfo<DaIotMonitorData>(list);
			List<DaIotMonitorData> modelList = pageInfo.getList();
