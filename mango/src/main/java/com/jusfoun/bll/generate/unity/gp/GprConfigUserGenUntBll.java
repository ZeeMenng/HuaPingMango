...
import com.zee.dao.unity.gp.IGprConfigUserUntDal;
...
public class GprConfigUserGenUntBll extends BaseUntBll<GprConfigUser> {
	...
	@Autowired
	protected IGprConfigUserUntDal gprConfigUserUntDal;


	public ResultModel updateList(GprConfigUserParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(GprConfigUserParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(GprConfigUserParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(GprConfigUserParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			GprConfigUserParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			GprConfigUserParameter.GetList.Page page = getListParam.getPage();
			ArrayList<GprConfigUserParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<GprConfigUser> list = baseUntDal.getList(map);
			PageInfo<GprConfigUser> pageInfo = new PageInfo<GprConfigUser>(list);
			List<GprConfigUser> modelList = pageInfo.getList();
	...
	public ResultModel deleteByUserId(String userId, boolean isLog) {
		...
		try {
			...
			int i = gprConfigUserUntDal.deleteByUserId( userId);
	...
	public ResultModel deleteByUserIdList(ArrayList<String> userIdList, boolean isLog) {
		...
		try {
			...
			int i = gprConfigUserUntDal.deleteByUserIdList(userIdList);
	...
	public ResultModel getListByUserId(String userId, boolean isLog) {
		...
		try {
			...
			List<GprConfigUser> modelList = gprConfigUserUntDal.getListByUserId(userId);
 	...
 	public ResultModel deleteByConfigId(String configId) {
		return deleteByConfigId(configId, isLogRead);
	}

	public ResultModel deleteByConfigId(String configId, boolean isLog) {
		ResultModel result = new ResultModel();
		try {
			result.setAddTime(DateUtils.getCurrentTime());
			result.setId(Tools.getUUID());
			result.setIncomeValue(configId);
			result.setTableName(this.getClass().getSimpleName());
			result.setOperTypeCode(OperType.DELETE.getCode());
			result.setOperTypeText(OperType.DELETE.getText());
			result.setRemark("根据外键，删除中间表数据。");

			int i = gprConfigUserUntDal.deleteByConfigId( configId);
 	...
 	public ResultModel deleteByConfigIdList(ArrayList<String> configIdList) {
		return deleteByConfigIdList(configIdList, isLogRead);
	}

	public ResultModel deleteByConfigIdList(ArrayList<String> configIdList, boolean isLog) {
		ResultModel result = new ResultModel();
		try {
			result.setAddTime(DateUtils.getCurrentTime());
			result.setId(Tools.getUUID());
			result.setIncomeValue(JSONArray.fromObject( configIdList).toString());
			result.setObjectId("");
			result.setTableName(this.getClass().getSimpleName());
			result.setOperTypeCode(OperType.DELETELIST.getCode());
			result.setOperTypeText(OperType.DELETELIST.getText());
			...
			int i = gprConfigUserUntDal.deleteByConfigIdList(configIdList);
	...
	public ResultModel getListByConfigId(String configId) {
		return getListByConfigId(configId, isLogRead);
	}

	public ResultModel getListByConfigId(String configId, boolean isLog) {
		ResultModel result = new ResultModel();
		try {
			result.setAddTime(DateUtils.getCurrentTime());
			result.setId(Tools.getUUID());
			...
			List<GprConfigUser> modelList = gprConfigUserUntDal.getListByConfigId(configId);
 	...
 	public ResultModel deleteByCompositeIdList(ArrayList<GprConfigUser> gprConfigUserList) {
		return deleteByCompositeIdList(gprConfigUserList, isLogWrite);
	}

	public ResultModel deleteByCompositeIdList(ArrayList<GprConfigUser> gprConfigUserList, boolean isLog) {
		ResultModel result = new ResultModel();
		if (gprConfigUserList == null || gprConfigUserList.isEmpty()) {
		...
		try {
			result.setId(Tools.getUUID());
			result.setIncomeValue(JSONArray.fromObject(gprConfigUserList).toString());
			result.setAddTime(DateUtils.getCurrentTime());
			result.setTableName(this.getClass().getSimpleName());
			result.setOperTypeCode(OperType.DELETELIST.getCode());
			result.setOperTypeText(OperType.DELETELIST.getText());
			...
			int i = gprConfigUserUntDal.deleteByCompositeIdList(gprConfigUserList);
