...
import com.zee.dao.unity.mf.IMfSaleEcommerceCrawUntDal;
import com.zee.ent.custom.ResultModel;
import com.zee.ent.extend.mf.MfSaleEcommerceCraw;
import com.zee.ent.parameter.mf.MfSaleEcommerceCrawParameter;
 ...
 * @description 电商数据表,采集 业务逻辑处理类，扩展自BaseUntBll<MfSaleEcommerceCraw>，自动生成。
 */
public class MfSaleEcommerceCrawGenUntBll extends BaseUntBll<MfSaleEcommerceCraw> {

	@Autowired
	protected IMfSaleEcommerceCrawUntDal mfSaleEcommerceCrawUntDal;


	public ResultModel updateList(MfSaleEcommerceCrawParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(MfSaleEcommerceCrawParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(MfSaleEcommerceCrawParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(MfSaleEcommerceCrawParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			MfSaleEcommerceCrawParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			MfSaleEcommerceCrawParameter.GetList.Page page = getListParam.getPage();
			ArrayList<MfSaleEcommerceCrawParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<MfSaleEcommerceCraw> list = baseUntDal.getList(map);
			PageInfo<MfSaleEcommerceCraw> pageInfo = new PageInfo<MfSaleEcommerceCraw>(list);
			List<MfSaleEcommerceCraw> modelList = pageInfo.getList();
