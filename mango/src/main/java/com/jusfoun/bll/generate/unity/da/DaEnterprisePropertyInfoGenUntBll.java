...
import com.jusfoun.dao.unity.da.IDaEnterprisePropertyInfoUntDal;
import com.jusfoun.ent.custom.ResultModel;
import com.jusfoun.ent.extend.da.DaEnterprisePropertyInfo;
import com.jusfoun.ent.parameter.da.DaEnterprisePropertyInfoParameter;
 ...
 * @description 企业财产信息表 业务逻辑处理类，扩展自BaseUntBll<DaEnterprisePropertyInfo>，自动生成。
 */
public class DaEnterprisePropertyInfoGenUntBll extends BaseUntBll<DaEnterprisePropertyInfo> {

	@Autowired
	protected IDaEnterprisePropertyInfoUntDal daEnterprisePropertyInfoUntDal;


	public ResultModel updateList(DaEnterprisePropertyInfoParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(DaEnterprisePropertyInfoParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(DaEnterprisePropertyInfoParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(DaEnterprisePropertyInfoParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			DaEnterprisePropertyInfoParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			DaEnterprisePropertyInfoParameter.GetList.Page page = getListParam.getPage();
			ArrayList<DaEnterprisePropertyInfoParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<DaEnterprisePropertyInfo> list = baseUntDal.getList(map);
			PageInfo<DaEnterprisePropertyInfo> pageInfo = new PageInfo<DaEnterprisePropertyInfo>(list);
			List<DaEnterprisePropertyInfo> modelList = pageInfo.getList();
