...
import com.jusfoun.dao.unity.da.IDaIotMonitorBasicUntDal;
import com.jusfoun.ent.custom.ResultModel;
import com.jusfoun.ent.extend.da.DaIotMonitorBasic;
import com.jusfoun.ent.parameter.da.DaIotMonitorBasicParameter;
 ...
 * @description 物联网设备基本信息 业务逻辑处理类，扩展自BaseUntBll<DaIotMonitorBasic>，自动生成。
 */
public class DaIotMonitorBasicGenUntBll extends BaseUntBll<DaIotMonitorBasic> {

	@Autowired
	protected IDaIotMonitorBasicUntDal daIotMonitorBasicUntDal;


	public ResultModel updateList(DaIotMonitorBasicParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(DaIotMonitorBasicParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(DaIotMonitorBasicParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(DaIotMonitorBasicParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			DaIotMonitorBasicParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			DaIotMonitorBasicParameter.GetList.Page page = getListParam.getPage();
			ArrayList<DaIotMonitorBasicParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<DaIotMonitorBasic> list = baseUntDal.getList(map);
			PageInfo<DaIotMonitorBasic> pageInfo = new PageInfo<DaIotMonitorBasic>(list);
			List<DaIotMonitorBasic> modelList = pageInfo.getList();
