...
import com.jusfoun.dao.unity.da.IDaEnterpriseUpdownstreamInfoUntDal;
import com.jusfoun.ent.custom.ResultModel;
import com.jusfoun.ent.extend.da.DaEnterpriseUpdownstreamInfo;
import com.jusfoun.ent.parameter.da.DaEnterpriseUpdownstreamInfoParameter;
 ...
 * @description 企业关联企业表，企业上下游关系记录。 业务逻辑处理类，扩展自BaseUntBll<DaEnterpriseUpdownstreamInfo>，自动生成。
 */
public class DaEnterpriseUpdownstreamInfoGenUntBll extends BaseUntBll<DaEnterpriseUpdownstreamInfo> {

	@Autowired
	protected IDaEnterpriseUpdownstreamInfoUntDal daEnterpriseUpdownstreamInfoUntDal;


	public ResultModel updateList(DaEnterpriseUpdownstreamInfoParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(DaEnterpriseUpdownstreamInfoParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(DaEnterpriseUpdownstreamInfoParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(DaEnterpriseUpdownstreamInfoParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			DaEnterpriseUpdownstreamInfoParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			DaEnterpriseUpdownstreamInfoParameter.GetList.Page page = getListParam.getPage();
			ArrayList<DaEnterpriseUpdownstreamInfoParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<DaEnterpriseUpdownstreamInfo> list = baseUntDal.getList(map);
			PageInfo<DaEnterpriseUpdownstreamInfo> pageInfo = new PageInfo<DaEnterpriseUpdownstreamInfo>(list);
			List<DaEnterpriseUpdownstreamInfo> modelList = pageInfo.getList();
