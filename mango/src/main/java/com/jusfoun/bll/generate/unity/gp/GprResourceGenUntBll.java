...
import com.jusfoun.dao.unity.gp.IGprResourceUntDal;
...
public class GprResourceGenUntBll extends BaseUntBll<GprResource> {
	...
	@Autowired
	protected IGprResourceUntDal gprResourceUntDal;


	public ResultModel updateList(GprResourceParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(GprResourceParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(GprResourceParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(GprResourceParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			GprResourceParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			GprResourceParameter.GetList.Page page = getListParam.getPage();
			ArrayList<GprResourceParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<GprResource> list = baseUntDal.getList(map);
			PageInfo<GprResource> pageInfo = new PageInfo<GprResource>(list);
			List<GprResource> modelList = pageInfo.getList();
 	...
 	public ResultModel deleteByResourceId(String resourceId) {
		return deleteByResourceId(resourceId, isLogRead);
	}

	public ResultModel deleteByResourceId(String resourceId, boolean isLog) {
		ResultModel result = new ResultModel();
		try {
			result.setAddTime(DateUtils.getCurrentTime());
			result.setId(Tools.getUUID());
			result.setIncomeValue(resourceId);
			result.setTableName(this.getClass().getSimpleName());
			...
			int i = gprResourceUntDal.deleteByResourceId( resourceId);
 	...
 	public ResultModel deleteByResourceIdList(ArrayList<String> resourceIdList) {
		return deleteByResourceIdList(resourceIdList, isLogRead);
	}

	public ResultModel deleteByResourceIdList(ArrayList<String> resourceIdList, boolean isLog) {
		ResultModel result = new ResultModel();
		try {
			result.setAddTime(DateUtils.getCurrentTime());
			result.setId(Tools.getUUID());
			result.setIncomeValue(JSONArray.fromObject( resourceIdList).toString());
			result.setObjectId("");
			result.setTableName(this.getClass().getSimpleName());
			...
			int i = gprResourceUntDal.deleteByResourceIdList(resourceIdList);
	...
	public ResultModel getListByResourceId(String resourceId) {
		return getListByResourceId(resourceId, isLogRead);
	}

	public ResultModel getListByResourceId(String resourceId, boolean isLog) {
		ResultModel result = new ResultModel();
		try {
			result.setAddTime(DateUtils.getCurrentTime());
			result.setId(Tools.getUUID());
			...
			List<GprResource> modelList = gprResourceUntDal.getListByResourceId(resourceId);
