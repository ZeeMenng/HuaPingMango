...
import com.jusfoun.dao.unity.gp.IGpConfigUntDal;
...
public class GpConfigGenUntBll extends BaseUntBll<GpConfig> {
	...
	public ResultModel updateList(GpConfigParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(GpConfigParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(GpConfigParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			ArrayList<GpConfigParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<GpConfig> list = baseUntDal.getList(map);
			PageInfo<GpConfig> pageInfo = new PageInfo<GpConfig>(list);
			List<GpConfig> modelList = pageInfo.getList();
