...
import com.zee.dao.unity.da.IDaIotMonitorQueryDateUntDal;
 ...
 * @description 物联网数据最新查询时间表 业务逻辑处理类，扩展自BaseUntBll<DaIotMonitorQueryDate>，自动生成。
 */
public class DaIotMonitorQueryDateGenUntBll extends BaseUntBll<DaIotMonitorQueryDate> {

	@Autowired
	protected IDaIotMonitorQueryDateUntDal daIotMonitorQueryDateUntDal;


	public ResultModel updateList(DaIotMonitorQueryDateParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(DaIotMonitorQueryDateParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(DaIotMonitorQueryDateParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(DaIotMonitorQueryDateParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			DaIotMonitorQueryDateParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			DaIotMonitorQueryDateParameter.GetList.Page page = getListParam.getPage();
			ArrayList<DaIotMonitorQueryDateParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<DaIotMonitorQueryDate> list = baseUntDal.getList(map);
			PageInfo<DaIotMonitorQueryDate> pageInfo = new PageInfo<DaIotMonitorQueryDate>(list);
			List<DaIotMonitorQueryDate> modelList = pageInfo.getList();
