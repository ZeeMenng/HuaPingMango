...
import com.jusfoun.dao.unity.da.IDaSentimentThemeUntDal;
...
public class DaSentimentThemeGenUntBll extends BaseUntBll<DaSentimentTheme> {
	...
	@Autowired
	protected IDaSentimentThemeUntDal daSentimentThemeUntDal;


	public ResultModel updateList(DaSentimentThemeParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(DaSentimentThemeParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(DaSentimentThemeParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(DaSentimentThemeParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			DaSentimentThemeParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			DaSentimentThemeParameter.GetList.Page page = getListParam.getPage();
			ArrayList<DaSentimentThemeParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<DaSentimentTheme> list = baseUntDal.getList(map);
			PageInfo<DaSentimentTheme> pageInfo = new PageInfo<DaSentimentTheme>(list);
			List<DaSentimentTheme> modelList = pageInfo.getList();
