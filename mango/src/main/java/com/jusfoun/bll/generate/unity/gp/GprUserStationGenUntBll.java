...
import com.jusfoun.dao.unity.gp.IGprUserStationUntDal;
import com.jusfoun.ent.custom.ResultModel;
import com.jusfoun.ent.extend.gp.GprUserStation;
import com.jusfoun.ent.parameter.gp.GprUserStationParameter;
...
public class GprUserStationGenUntBll extends BaseUntBll<GprUserStation> {
	...
	public ResultModel getList(GprUserStationParameter.GetList getListParam, boolean isLog) {
 	...
 	public ResultModel deleteByStationId(String stationId) {
		return deleteByStationId(stationId, isLogRead);
	}

	public ResultModel deleteByStationId(String stationId, boolean isLog) {
		ResultModel result = new ResultModel();
		try {
			result.setAddTime(DateUtils.getCurrentTime());
			result.setId(Tools.getUUID());
			result.setIncomeValue(stationId);
			result.setTableName(this.getClass().getSimpleName());
			...
			int i = gprUserStationUntDal.deleteByStationId( stationId);
 	...
 	public ResultModel deleteByStationIdList(ArrayList<String> stationIdList) {
		return deleteByStationIdList(stationIdList, isLogRead);
	}

	public ResultModel deleteByStationIdList(ArrayList<String> stationIdList, boolean isLog) {
		ResultModel result = new ResultModel();
		try {
			result.setAddTime(DateUtils.getCurrentTime());
			result.setId(Tools.getUUID());
			result.setIncomeValue(JSONArray.fromObject( stationIdList).toString());
			result.setObjectId("");
			result.setTableName(this.getClass().getSimpleName());
			...
			int i = gprUserStationUntDal.deleteByStationIdList(stationIdList);
	...
	public ResultModel getListByStationId(String stationId) {
		return getListByStationId(stationId, isLogRead);
	}

	public ResultModel getListByStationId(String stationId, boolean isLog) {
		ResultModel result = new ResultModel();
		try {
			result.setAddTime(DateUtils.getCurrentTime());
			result.setId(Tools.getUUID());
			...
			List<GprUserStation> modelList = gprUserStationUntDal.getListByStationId(stationId);
	...
	public ResultModel deleteByUserId(String userId, boolean isLog) {
		...
		try {
			...
			int i = gprUserStationUntDal.deleteByUserId( userId);
	...
	public ResultModel deleteByUserIdList(ArrayList<String> userIdList, boolean isLog) {
		...
		try {
			...
			int i = gprUserStationUntDal.deleteByUserIdList(userIdList);
	...
	public ResultModel getListByUserId(String userId, boolean isLog) {
		...
		try {
			...
			List<GprUserStation> modelList = gprUserStationUntDal.getListByUserId(userId);
 	...
 	public ResultModel deleteByCompositeIdList(ArrayList<GprUserStation> gprUserStationList) {
		return deleteByCompositeIdList(gprUserStationList, isLogWrite);
	}

	public ResultModel deleteByCompositeIdList(ArrayList<GprUserStation> gprUserStationList, boolean isLog) {
		ResultModel result = new ResultModel();
		if (gprUserStationList == null || gprUserStationList.isEmpty()) {
		...
		try {
			result.setId(Tools.getUUID());
			result.setIncomeValue(JSONArray.fromObject(gprUserStationList).toString());
			result.setAddTime(DateUtils.getCurrentTime());
			result.setTableName(this.getClass().getSimpleName());
			result.setOperTypeCode(OperType.DELETELIST.getCode());
			result.setOperTypeText(OperType.DELETELIST.getText());
			...
			int i = gprUserStationUntDal.deleteByCompositeIdList(gprUserStationList);
