...
import com.jusfoun.dao.unity.da.IDaWholesaleMarketUntDal;
...
public class DaWholesaleMarketGenUntBll extends BaseUntBll<DaWholesaleMarket> {
	...
	@Autowired
	protected IDaWholesaleMarketUntDal daWholesaleMarketUntDal;


	public ResultModel updateList(DaWholesaleMarketParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(DaWholesaleMarketParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(DaWholesaleMarketParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(DaWholesaleMarketParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			DaWholesaleMarketParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			DaWholesaleMarketParameter.GetList.Page page = getListParam.getPage();
			ArrayList<DaWholesaleMarketParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<DaWholesaleMarket> list = baseUntDal.getList(map);
			PageInfo<DaWholesaleMarket> pageInfo = new PageInfo<DaWholesaleMarket>(list);
			List<DaWholesaleMarket> modelList = pageInfo.getList();
