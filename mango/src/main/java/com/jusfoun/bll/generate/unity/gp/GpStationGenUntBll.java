...
import com.jusfoun.dao.unity.gp.IGpStationUntDal;
import com.jusfoun.ent.custom.ResultModel;
import com.jusfoun.ent.extend.gp.GpStation;
import com.jusfoun.ent.parameter.gp.GpStationParameter;
...
public class GpStationGenUntBll extends BaseUntBll<GpStation> {
	...
	public ResultModel deleteByOrganizationId(String organizationId, boolean isLog) {
		...
		try {
			...
			int i = gpStationUntDal.deleteByOrganizationId( organizationId);
	...
	public ResultModel getListByOrganizationId(String organizationId, boolean isLog) {
		...
		try {
			...
			List<GpStation> modelList = gpStationUntDal.getListByOrganizationId(organizationId);
