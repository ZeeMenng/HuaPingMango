...
import com.zee.dao.unity.pi.IPirProductResourceUntDal;
...
public class PirProductResourceGenUntBll extends BaseUntBll<PirProductResource> {
	...
	@Autowired
	protected IPirProductResourceUntDal pirProductResourceUntDal;


	public ResultModel updateList(PirProductResourceParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(PirProductResourceParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(PirProductResourceParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(PirProductResourceParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			PirProductResourceParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			PirProductResourceParameter.GetList.Page page = getListParam.getPage();
			ArrayList<PirProductResourceParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<PirProductResource> list = baseUntDal.getList(map);
			PageInfo<PirProductResource> pageInfo = new PageInfo<PirProductResource>(list);
			List<PirProductResource> modelList = pageInfo.getList();
