...
import com.zee.dao.unity.mf.IMfWeatherUntDal;
...
public class MfWeatherGenUntBll extends BaseUntBll<MfWeather> {
	...
	@Autowired
	protected IMfWeatherUntDal mfWeatherUntDal;


	public ResultModel updateList(MfWeatherParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(MfWeatherParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(MfWeatherParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(MfWeatherParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			MfWeatherParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			MfWeatherParameter.GetList.Page page = getListParam.getPage();
			ArrayList<MfWeatherParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<MfWeather> list = baseUntDal.getList(map);
			PageInfo<MfWeather> pageInfo = new PageInfo<MfWeather>(list);
			List<MfWeather> modelList = pageInfo.getList();
