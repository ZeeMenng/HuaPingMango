...
import com.jusfoun.dao.unity.da.IDaIotDictionaryUntDal;
 ...
 * @description 物联网传感器设备字典 业务逻辑处理类，扩展自BaseUntBll<DaIotDictionary>，自动生成。
 */
public class DaIotDictionaryGenUntBll extends BaseUntBll<DaIotDictionary> {

	@Autowired
	protected IDaIotDictionaryUntDal daIotDictionaryUntDal;


	public ResultModel updateList(DaIotDictionaryParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(DaIotDictionaryParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(DaIotDictionaryParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(DaIotDictionaryParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			DaIotDictionaryParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			DaIotDictionaryParameter.GetList.Page page = getListParam.getPage();
			ArrayList<DaIotDictionaryParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<DaIotDictionary> list = baseUntDal.getList(map);
			PageInfo<DaIotDictionary> pageInfo = new PageInfo<DaIotDictionary>(list);
			List<DaIotDictionary> modelList = pageInfo.getList();
