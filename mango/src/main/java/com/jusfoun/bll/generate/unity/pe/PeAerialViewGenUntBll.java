...
import com.zee.dao.unity.pe.IPeAerialViewUntDal;
...
public class PeAerialViewGenUntBll extends BaseUntBll<PeAerialView> {
	...
	@Autowired
	protected IPeAerialViewUntDal peAerialViewUntDal;


	public ResultModel updateList(PeAerialViewParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(PeAerialViewParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(PeAerialViewParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(PeAerialViewParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			PeAerialViewParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			PeAerialViewParameter.GetList.Page page = getListParam.getPage();
			ArrayList<PeAerialViewParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<PeAerialView> list = baseUntDal.getList(map);
			PageInfo<PeAerialView> pageInfo = new PageInfo<PeAerialView>(list);
			List<PeAerialView> modelList = pageInfo.getList();
