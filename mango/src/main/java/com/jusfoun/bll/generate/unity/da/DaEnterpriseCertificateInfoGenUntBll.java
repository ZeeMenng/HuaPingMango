...
import com.jusfoun.dao.unity.da.IDaEnterpriseCertificateInfoUntDal;
import com.jusfoun.ent.custom.ResultModel;
import com.jusfoun.ent.extend.da.DaEnterpriseCertificateInfo;
import com.jusfoun.ent.parameter.da.DaEnterpriseCertificateInfoParameter;
 ...
 * @description 企业证书 业务逻辑处理类，扩展自BaseUntBll<DaEnterpriseCertificateInfo>，自动生成。
 */
public class DaEnterpriseCertificateInfoGenUntBll extends BaseUntBll<DaEnterpriseCertificateInfo> {

	@Autowired
	protected IDaEnterpriseCertificateInfoUntDal daEnterpriseCertificateInfoUntDal;


	public ResultModel updateList(DaEnterpriseCertificateInfoParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(DaEnterpriseCertificateInfoParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(DaEnterpriseCertificateInfoParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(DaEnterpriseCertificateInfoParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			DaEnterpriseCertificateInfoParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			DaEnterpriseCertificateInfoParameter.GetList.Page page = getListParam.getPage();
			ArrayList<DaEnterpriseCertificateInfoParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<DaEnterpriseCertificateInfo> list = baseUntDal.getList(map);
			PageInfo<DaEnterpriseCertificateInfo> pageInfo = new PageInfo<DaEnterpriseCertificateInfo>(list);
			List<DaEnterpriseCertificateInfo> modelList = pageInfo.getList();
