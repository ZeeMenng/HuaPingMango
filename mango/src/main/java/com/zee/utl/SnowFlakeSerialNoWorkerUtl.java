 ...
 * @updateTime 2020年9月17日 下午2:14:58
 * @description 
 *      雪花算法（Snowflake）是twitter公司内部分布式项目采用的ID生成算法，使用SnowFlake算法生成一个整数，然后转化为62进制变成一个短地址URL。
...
public class SnowFlakeSerialNoWorkerUtl {
	...
	/**
	     ...
	     */
	public SnowFlakeSerialNoWorkerUtl(long workerId, long datacenterId) {
	...
	public static void main(String[] args) {
		SnowFlakeSerialNoWorkerUtl idWorker = new SnowFlakeSerialNoWorkerUtl(31, 31);
