...
import com.zee.bll.extend.split.da.DaCommonFieldSplBll;
 ...
 * @description 通用字段表 对外接口，扩展自BaseSwgApp，自动生成。
 */

@Api(value = "DaCommonField",tags="通用字段表")
...
public class DaCommonFieldGenSwgApp extends BaseSwgApp {
	...
	public void exportExcel() {
		...
		String fileName = "通用字段表列表数据" + DateUtils.getCurrentDateStr() + ".xls";
		String jsonData = request.getParameter(CustomSymbolic.CONTROLLER_PARAM_JSON);
