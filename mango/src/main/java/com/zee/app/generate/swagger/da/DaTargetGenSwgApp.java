...
import com.zee.bll.extend.split.da.DaTargetSplBll;
import com.zee.bll.extend.unity.da.DaTargetUntBll;
 ...
 * @description 指标数据 对外接口，扩展自BaseSwgApp，自动生成。
 */

@Api(value = "DaTarget",tags="指标数据")
...
public class DaTargetGenSwgApp extends BaseSwgApp {
	...
	public void exportExcel() {
		...
		String fileName = "指标数据列表数据" + DateUtils.getCurrentDateStr() + ".xls";
		String jsonData = request.getParameter(SymbolicConstant.CONTROLLER_PARAM_JSON);
