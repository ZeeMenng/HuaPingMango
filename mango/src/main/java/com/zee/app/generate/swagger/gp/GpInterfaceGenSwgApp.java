...
@Api(value = "GpInterface",tags="系统接口。")
@RequestMapping(value = "/generate/swagger/gp/gpInterface")
public class GpInterfaceGenSwgApp extends BaseSwgApp {
	...
	@Autowired
	@Qualifier("gpInterfaceSplBll")
	protected GpInterfaceSplBll gpInterfaceSplBll;

	@ApiOperation(value = "新增记录", notes = "新增单条记录")
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串", required = true, dataType = "GpInterface") })
	@RequestMapping(value = "/add", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel add(@RequestBody GpInterface jsonData) {
		ResultModel result = gpInterfaceUntBll.add(jsonData);

		return result;
	}

	@ApiOperation(value = "批量新增", notes = "新增多条记录")
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，对象列表", required = true, dataType = "GpInterfaceAddList") })
	@RequestMapping(value = "/addList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel addList(@RequestBody GpInterfaceParameter.AddList jsonData) {
		ResultModel result = gpInterfaceUntBll.add(jsonData.getEntityList());
	...
	public ResultModel delete(@RequestParam String id) {
		ResultModel result = gpInterfaceUntBll.delete(id);
	...
	@ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，主键列表", required = true, dataType = "GpInterfaceDeleteByIdList")
	@RequestMapping(value = "/deleteList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel deleteList(@RequestBody GpInterfaceParameter.DeleteByIdList jsonData) {
		ResultModel result = gpInterfaceUntBll.deleteByIdList(jsonData.getIdList());
    ...
    public ResultModel updateListWithDff(@RequestBody GpInterfaceParameter.AddList jsonData) {
		ResultModel result = gpInterfaceUntBll.updateListWithDff(jsonData.getEntityList());
    ...
    public ResultModel updateListWithDffOrAdd(@RequestBody GpInterfaceParameter.AddList jsonData) {
		ResultModel result = gpInterfaceUntBll.updateListWithDffOrAdd(jsonData.getEntityList());
	...
	@ApiImplicitParams({ @ApiImplicitParam(paramType = "body", name = "jsonData", value = "json字符串，查询参数", required = true, dataType = "GpInterfaceGetList") })
	@RequestMapping(value = "/getList", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResultModel getList(@RequestBody GpInterfaceParameter.GetList jsonData) {
		// 处理业务与返回数据
		ResultModel result = gpInterfaceUntBll.getList(jsonData);
