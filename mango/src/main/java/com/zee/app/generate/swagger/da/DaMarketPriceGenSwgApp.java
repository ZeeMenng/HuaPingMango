...
import com.zee.bll.extend.split.da.DaMarketPriceSplBll;
 ...
 * @description 市场价格数据表 对外接口，扩展自BaseSwgApp，自动生成。
 */

@Api(value = "DaMarketPrice",tags="市场价格数据表")
...
public class DaMarketPriceGenSwgApp extends BaseSwgApp {
	...
	public void exportExcel() {
		...
		String fileName = "市场价格数据表列表数据" + DateUtils.getCurrentDateStr() + ".xls";
		String jsonData = request.getParameter(CustomSymbolic.CONTROLLER_PARAM_JSON);
