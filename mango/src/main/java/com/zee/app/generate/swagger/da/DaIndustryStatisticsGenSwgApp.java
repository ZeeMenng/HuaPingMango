...
import com.zee.bll.extend.split.da.DaIndustryStatisticsSplBll;
import com.zee.bll.extend.unity.da.DaIndustryStatisticsUntBll;
 ...
 * @description 产业统计数据表 对外接口，扩展自BaseSwgApp，自动生成。
 */

@Api(value = "DaIndustryStatistics",tags="产业统计数据表")
...
public class DaIndustryStatisticsGenSwgApp extends BaseSwgApp {
	...
	public void exportExcel() {
		...
		String fileName = "产业统计数据表列表数据" + DateUtils.getCurrentDateStr() + ".xls";
		String jsonData = request.getParameter(CustomSymbolic.CONTROLLER_PARAM_JSON);
