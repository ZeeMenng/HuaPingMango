...
import com.zee.bll.extend.split.mf.MfHpFluctSplBll;
 ...
 * @description 批发价格周期性波动规律分析 对外接口，扩展自BaseSwgApp，自动生成。
 */

@Api(value = "MfHpFluct",tags="批发价格周期性波动规律分析")
...
public class MfHpFluctGenSwgApp extends BaseSwgApp {
	...
	public void exportExcel() {
		...
		String fileName = "批发价格周期性波动规律分析列表数据" + DateUtils.getCurrentDateStr() + ".xls";
		String jsonData = request.getParameter(CustomSymbolic.CONTROLLER_PARAM_JSON);
