...
import com.zee.bll.extend.split.gp.GprConfigDomainSplBll;
import com.zee.bll.extend.unity.gp.GprConfigDomainUntBll;
...
public class GprConfigDomainGenSwgApp extends BaseSwgApp {
	...
	public void exportExcel() {
		...
		String fileName = "应用领域配置信息列表数据" + DateUtils.getCurrentDateStr() + ".xls";
		String jsonData = request.getParameter(CustomSymbolic.CONTROLLER_PARAM_JSON);
