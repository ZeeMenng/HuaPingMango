...
public class GpMessageSwgApp extends GpMessageGenSwgApp {
	...
	public ResultModel getModelByPath(@PathVariable("id") String id) {
		...
		List<Map<String, Object>> messageList = (List<Map<String, Object>>) resultModel.getData();
	...
	public ResultModel getListByJsonData() {
		...
		selectBuffer.append(" from gp_message A LEFT JOIN gpr_message_user C on C.message_id = A.id LEFT JOIN gp_user B on A.user_id = B.id and A.user_name = B.user_name where 1=1 ");
...
//					selectBuffer.append(" and C.user_id in('");
			...
			if (jsonObject.containsKey("entityRelated")) {
				...
				if (entityRelatedObject.containsKey("id") && StringUtils.isNotBlank(entityRelatedObject.getString("id")))
					selectBuffer.append(" and C.user_id like '%").append(entityRelatedObject.getString("id")).append("%'");
				...
				if (entityRelatedObject.containsKey("messageType") && StringUtils.isNotBlank(entityRelatedObject.getString("messageType")))
					selectBuffer.append(" and (CASE when B.is_admin_code='0' then '系统消息' when B.is_admin_code='1' then '用户消息' end) like '%").append(entityRelatedObject.getString("messageType")).append("%'");
			}
