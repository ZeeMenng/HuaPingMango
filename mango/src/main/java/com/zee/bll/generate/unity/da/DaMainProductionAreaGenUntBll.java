...
import com.zee.dao.unity.da.IDaMainProductionAreaUntDal;
 ...
 * @description 芒果主产区 业务逻辑处理类，扩展自BaseUntBll<DaMainProductionArea>，自动生成。
 */
public class DaMainProductionAreaGenUntBll extends BaseUntBll<DaMainProductionArea> {

	@Autowired
	protected IDaMainProductionAreaUntDal daMainProductionAreaUntDal;


	public ResultModel updateList(DaMainProductionAreaParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(DaMainProductionAreaParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(DaMainProductionAreaParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(DaMainProductionAreaParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			DaMainProductionAreaParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			DaMainProductionAreaParameter.GetList.Page page = getListParam.getPage();
			ArrayList<DaMainProductionAreaParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<DaMainProductionArea> list = baseUntDal.getList(map);
			PageInfo<DaMainProductionArea> pageInfo = new PageInfo<DaMainProductionArea>(list);
			List<DaMainProductionArea> modelList = pageInfo.getList();
