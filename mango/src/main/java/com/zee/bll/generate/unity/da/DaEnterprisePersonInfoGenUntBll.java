...
import com.zee.dao.unity.da.IDaEnterprisePersonInfoUntDal;
 ...
 * @description 企业人员信息表 业务逻辑处理类，扩展自BaseUntBll<DaEnterprisePersonInfo>，自动生成。
 */
public class DaEnterprisePersonInfoGenUntBll extends BaseUntBll<DaEnterprisePersonInfo> {

	@Autowired
	protected IDaEnterprisePersonInfoUntDal daEnterprisePersonInfoUntDal;


	public ResultModel updateList(DaEnterprisePersonInfoParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(DaEnterprisePersonInfoParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(DaEnterprisePersonInfoParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(DaEnterprisePersonInfoParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			DaEnterprisePersonInfoParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			DaEnterprisePersonInfoParameter.GetList.Page page = getListParam.getPage();
			ArrayList<DaEnterprisePersonInfoParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<DaEnterprisePersonInfo> list = baseUntDal.getList(map);
			PageInfo<DaEnterprisePersonInfo> pageInfo = new PageInfo<DaEnterprisePersonInfo>(list);
			List<DaEnterprisePersonInfo> modelList = pageInfo.getList();
