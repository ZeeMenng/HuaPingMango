...
import com.zee.dao.unity.gp.IGprRoleInterfaceUntDal;
 ...
 * @updateDate 2021/2/2 18:48:10
 * @description 角色拥有的接口权限。 业务逻辑处理类，扩展自BaseUntBll<GprRoleInterface>，自动生成。
 */
public class GprRoleInterfaceGenUntBll extends BaseUntBll<GprRoleInterface> {

	@Autowired
	protected IGprRoleInterfaceUntDal gprRoleInterfaceUntDal;


	public ResultModel updateList(GprRoleInterfaceParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(GprRoleInterfaceParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(GprRoleInterfaceParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(GprRoleInterfaceParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			GprRoleInterfaceParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			GprRoleInterfaceParameter.GetList.Page page = getListParam.getPage();
			ArrayList<GprRoleInterfaceParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<GprRoleInterface> list = baseUntDal.getList(map);
			PageInfo<GprRoleInterface> pageInfo = new PageInfo<GprRoleInterface>(list);
			List<GprRoleInterface> modelList = pageInfo.getList();
	...
	public ResultModel deleteByInterfaceId(String interfaceId, boolean isLog) {
		...
		try {
			...
			int i = gprRoleInterfaceUntDal.deleteByInterfaceId( interfaceId);
	...
	public ResultModel deleteByInterfaceIdList(ArrayList<String> interfaceIdList, boolean isLog) {
		...
		try {
			...
			int i = gprRoleInterfaceUntDal.deleteByInterfaceIdList(interfaceIdList);
	...
	public ResultModel getListByInterfaceId(String interfaceId, boolean isLog) {
		...
		try {
			...
			List<GprRoleInterface> modelList = gprRoleInterfaceUntDal.getListByInterfaceId(interfaceId);
	...
	public ResultModel deleteByRoleId(String roleId, boolean isLog) {
		...
		try {
			...
			int i = gprRoleInterfaceUntDal.deleteByRoleId( roleId);
	...
	public ResultModel deleteByRoleIdList(ArrayList<String> roleIdList, boolean isLog) {
		...
		try {
			...
			int i = gprRoleInterfaceUntDal.deleteByRoleIdList(roleIdList);
	...
	public ResultModel getListByRoleId(String roleId, boolean isLog) {
		...
		try {
			...
			List<GprRoleInterface> modelList = gprRoleInterfaceUntDal.getListByRoleId(roleId);
	...
	public ResultModel deleteByCompositeIdList(ArrayList<GprRoleInterface> gprRoleInterfaceList, boolean isLog) {
		...
		try {
			...
			int i = gprRoleInterfaceUntDal.deleteByCompositeIdList(gprRoleInterfaceList);
