...
public class PirContentChannelGenUntBll extends BaseUntBll<PirContentChannel> {
	...
	@Autowired
	protected IPirContentChannelUntDal pirContentChannelUntDal;


	public ResultModel updateList(PirContentChannelParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(PirContentChannelParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(PirContentChannelParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(PirContentChannelParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			PirContentChannelParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			PirContentChannelParameter.GetList.Page page = getListParam.getPage();
			ArrayList<PirContentChannelParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<PirContentChannel> list = baseUntDal.getList(map);
			PageInfo<PirContentChannel> pageInfo = new PageInfo<PirContentChannel>(list);
			List<PirContentChannel> modelList = pageInfo.getList();
