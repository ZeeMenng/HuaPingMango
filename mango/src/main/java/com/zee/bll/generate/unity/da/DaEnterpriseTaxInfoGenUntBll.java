...
import com.zee.dao.unity.da.IDaEnterpriseTaxInfoUntDal;
import com.zee.ent.custom.ResultModel;
import com.zee.ent.extend.da.DaEnterpriseTaxInfo;
import com.zee.ent.parameter.da.DaEnterpriseTaxInfoParameter;
 ...
 * @description 企业税务信息表 业务逻辑处理类，扩展自BaseUntBll<DaEnterpriseTaxInfo>，自动生成。
 */
public class DaEnterpriseTaxInfoGenUntBll extends BaseUntBll<DaEnterpriseTaxInfo> {

	@Autowired
	protected IDaEnterpriseTaxInfoUntDal daEnterpriseTaxInfoUntDal;


	public ResultModel updateList(DaEnterpriseTaxInfoParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(DaEnterpriseTaxInfoParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(DaEnterpriseTaxInfoParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(DaEnterpriseTaxInfoParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			DaEnterpriseTaxInfoParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			DaEnterpriseTaxInfoParameter.GetList.Page page = getListParam.getPage();
			ArrayList<DaEnterpriseTaxInfoParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<DaEnterpriseTaxInfo> list = baseUntDal.getList(map);
			PageInfo<DaEnterpriseTaxInfo> pageInfo = new PageInfo<DaEnterpriseTaxInfo>(list);
			List<DaEnterpriseTaxInfo> modelList = pageInfo.getList();
