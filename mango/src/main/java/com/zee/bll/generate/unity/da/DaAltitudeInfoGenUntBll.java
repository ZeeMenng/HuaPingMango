...
import com.zee.dao.unity.da.IDaAltitudeInfoUntDal;
 ...
 * @description 海拔数据表 业务逻辑处理类，扩展自BaseUntBll<DaAltitudeInfo>，自动生成。
 */
public class DaAltitudeInfoGenUntBll extends BaseUntBll<DaAltitudeInfo> {

	@Autowired
	protected IDaAltitudeInfoUntDal daAltitudeInfoUntDal;


	public ResultModel updateList(DaAltitudeInfoParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(DaAltitudeInfoParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(DaAltitudeInfoParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(DaAltitudeInfoParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			DaAltitudeInfoParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			DaAltitudeInfoParameter.GetList.Page page = getListParam.getPage();
			ArrayList<DaAltitudeInfoParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<DaAltitudeInfo> list = baseUntDal.getList(map);
			PageInfo<DaAltitudeInfo> pageInfo = new PageInfo<DaAltitudeInfo>(list);
			List<DaAltitudeInfo> modelList = pageInfo.getList();
