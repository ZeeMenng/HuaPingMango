...
import com.zee.dao.unity.da.IDaIotMonitorDisasterDataUntDal;
import com.zee.ent.custom.ResultModel;
import com.zee.ent.extend.da.DaIotMonitorDisasterData;
import com.zee.ent.parameter.da.DaIotMonitorDisasterDataParameter;
 ...
 * @updateDate 2021/1/29 17:00:39
 * @description da_iot_monitor_data表中满足预警条件的数据 业务逻辑处理类，扩展自BaseUntBll<DaIotMonitorDisasterData>，自动生成。
 */
public class DaIotMonitorDisasterDataGenUntBll extends BaseUntBll<DaIotMonitorDisasterData> {

	@Autowired
	protected IDaIotMonitorDisasterDataUntDal daIotMonitorDisasterDataUntDal;


	public ResultModel updateList(DaIotMonitorDisasterDataParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(DaIotMonitorDisasterDataParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(DaIotMonitorDisasterDataParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(DaIotMonitorDisasterDataParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			DaIotMonitorDisasterDataParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			DaIotMonitorDisasterDataParameter.GetList.Page page = getListParam.getPage();
			ArrayList<DaIotMonitorDisasterDataParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<DaIotMonitorDisasterData> list = baseUntDal.getList(map);
			PageInfo<DaIotMonitorDisasterData> pageInfo = new PageInfo<DaIotMonitorDisasterData>(list);
			List<DaIotMonitorDisasterData> modelList = pageInfo.getList();
