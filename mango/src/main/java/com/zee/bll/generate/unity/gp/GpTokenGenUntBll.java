...
import com.zee.dao.unity.gp.IGpTokenUntDal;
import com.zee.ent.custom.ResultModel;
import com.zee.ent.extend.gp.GpToken;
import com.zee.ent.parameter.gp.GpTokenParameter;
...
public class GpTokenGenUntBll extends BaseUntBll<GpToken> {
	...
	public ResultModel deleteByDomainId(String domainId, boolean isLog) {
		...
		try {
			...
			int i = gpTokenUntDal.deleteByDomainId( domainId);
	...
	public ResultModel deleteByDomainIdList(ArrayList<String> domainIdList, boolean isLog) {
		...
		try {
			...
			int i = gpTokenUntDal.deleteByDomainIdList(domainIdList);
	...
	public ResultModel getListByDomainId(String domainId, boolean isLog) {
		...
		try {
			...
			List<GpToken> modelList = gpTokenUntDal.getListByDomainId(domainId);
	...
	public ResultModel deleteByUserId(String userId, boolean isLog) {
		...
		try {
			...
			int i = gpTokenUntDal.deleteByUserId( userId);
	...
	public ResultModel deleteByUserIdList(ArrayList<String> userIdList, boolean isLog) {
		...
		try {
			...
			int i = gpTokenUntDal.deleteByUserIdList(userIdList);
	...
	public ResultModel getListByUserId(String userId, boolean isLog) {
		...
		try {
			...
			List<GpToken> modelList = gpTokenUntDal.getListByUserId(userId);
 	...
 	public ResultModel deleteByCompositeIdList(ArrayList<GpToken> gpTokenList) {
		return deleteByCompositeIdList(gpTokenList, isLogWrite);
	}

	public ResultModel deleteByCompositeIdList(ArrayList<GpToken> gpTokenList, boolean isLog) {
		ResultModel result = new ResultModel();
		if (gpTokenList == null || gpTokenList.isEmpty()) {
		...
		try {
			result.setId(Tools.getUUID());
			result.setIncomeValue(JSONArray.fromObject(gpTokenList).toString());
			result.setAddTime(DateUtils.getCurrentTime());
			result.setTableName(this.getClass().getSimpleName());
			result.setOperTypeCode(OperType.DELETELIST.getCode());
			result.setOperTypeText(OperType.DELETELIST.getText());
			...
			int i = gpTokenUntDal.deleteByCompositeIdList(gpTokenList);
