...
import com.zee.dao.unity.da.IDaEnterpriseLoanInfoUntDal;
 ...
 * @description 企业贷款记录表 业务逻辑处理类，扩展自BaseUntBll<DaEnterpriseLoanInfo>，自动生成。
 */
public class DaEnterpriseLoanInfoGenUntBll extends BaseUntBll<DaEnterpriseLoanInfo> {

	@Autowired
	protected IDaEnterpriseLoanInfoUntDal daEnterpriseLoanInfoUntDal;


	public ResultModel updateList(DaEnterpriseLoanInfoParameter.UpdateList updateListParam) {
		return updateList(updateListParam, isLogWrite);
	}

	public ResultModel updateList(DaEnterpriseLoanInfoParameter.UpdateList updateListParam, boolean isLog) {
	...
	public ResultModel getList(DaEnterpriseLoanInfoParameter.GetList getListParam) {
		return getList(getListParam, isLogRead);
	}

	public ResultModel getList(DaEnterpriseLoanInfoParameter.GetList getListParam, boolean isLog) {
		ResultModel result = new ResultModel();
		...
		try {
			...
			DaEnterpriseLoanInfoParameter.GetList.EntityRelated entityRelated = getListParam.getEntityRelated();
			DaEnterpriseLoanInfoParameter.GetList.Page page = getListParam.getPage();
			ArrayList<DaEnterpriseLoanInfoParameter.GetList.Order> orderList = getListParam.getOrderList();
			...
			List<DaEnterpriseLoanInfo> list = baseUntDal.getList(map);
			PageInfo<DaEnterpriseLoanInfo> pageInfo = new PageInfo<DaEnterpriseLoanInfo>(list);
			List<DaEnterpriseLoanInfo> modelList = pageInfo.getList();
