...
import com.zee.dao.unity.gp.IGpLoginLogUntDal;
import com.zee.ent.custom.ResultModel;
import com.zee.ent.extend.gp.GpLoginLog;
import com.zee.ent.parameter.gp.GpLoginLogParameter;
...
public class GpLoginLogGenUntBll extends BaseUntBll<GpLoginLog> {
	...
	public ResultModel deleteByDomainId(String domainId, boolean isLog) {
		...
		try {
			...
			int i = gpLoginLogUntDal.deleteByDomainId( domainId);
	...
	public ResultModel deleteByDomainIdList(ArrayList<String> domainIdList, boolean isLog) {
		...
		try {
			...
			int i = gpLoginLogUntDal.deleteByDomainIdList(domainIdList);
	...
	public ResultModel getListByDomainId(String domainId, boolean isLog) {
		...
		try {
			...
			List<GpLoginLog> modelList = gpLoginLogUntDal.getListByDomainId(domainId);
	...
	public ResultModel deleteByUserId(String userId, boolean isLog) {
		...
		try {
			...
			int i = gpLoginLogUntDal.deleteByUserId( userId);
	...
	public ResultModel deleteByUserIdList(ArrayList<String> userIdList, boolean isLog) {
		...
		try {
			...
			int i = gpLoginLogUntDal.deleteByUserIdList(userIdList);
	...
	public ResultModel getListByUserId(String userId, boolean isLog) {
		...
		try {
			...
			List<GpLoginLog> modelList = gpLoginLogUntDal.getListByUserId(userId);
 	...
 	public ResultModel deleteByCompositeIdList(ArrayList<GpLoginLog> gpLoginLogList) {
		return deleteByCompositeIdList(gpLoginLogList, isLogWrite);
	}

	public ResultModel deleteByCompositeIdList(ArrayList<GpLoginLog> gpLoginLogList, boolean isLog) {
		ResultModel result = new ResultModel();
		if (gpLoginLogList == null || gpLoginLogList.isEmpty()) {
		...
		try {
			result.setId(Tools.getUUID());
			result.setIncomeValue(JSONArray.fromObject(gpLoginLogList).toString());
			result.setAddTime(DateUtils.getCurrentTime());
			result.setTableName(this.getClass().getSimpleName());
			result.setOperTypeCode(OperType.DELETELIST.getCode());
			result.setOperTypeText(OperType.DELETELIST.getText());
			...
			int i = gpLoginLogUntDal.deleteByCompositeIdList(gpLoginLogList);
