...
import com.zee.dao.split.gp.IGpInterfaceSplDal;
 ...
 * @description 系统接口。 业务逻辑处理类，扩展自BaseSplBll<GpInterface>，自动生成。
 */
public class GpInterfaceGenSplBll extends BaseSplBll {
