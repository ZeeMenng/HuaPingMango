	...
	return this.each(function() {
		...
		function drawLinks() {
			...
			if (opts.first_text && (current_page > 0 || opts.prev_show_always)) {      
				appendItem(0, { text: opts.first_text, classes: "prev disabled home" });           
			} 
			...
			if (opts.last_text && (current_page < np - 1 || opts.next_show_always)) {            
				 appendItem(np, { text: opts.last_text, classes: "prev disabled end" });          
			}
	        /****************** Added ***************/
            /*插入一个文本框，用户输入并回车后进行跳转*/
            var totleNum = '<b>共</b><b id="totleNum">'+Math.ceil(opts.totleNum/opts.items_per_page)+'</b><b class="pr10">页</b>'
			var pagetext = '<b>到第</b><input id="pagevalue" size="1" value="'+(current_page+1)+'"type="text"><b>页</b>';
            var toPage='<span><a id="search" href="#">确定</a></span>';
            $(totleNum).appendTo(panel);
