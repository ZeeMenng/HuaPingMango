...
function getDetiles(currentPage){
    ...
    ajaxGet("mango/extend/swagger/pi/piContent/getWebSiteBaseInfo",params,rendomDetiles)
}
getDetiles();
//网站声明的回调函数
...
function getAboutUs(currentPage){
    ...
    ajaxGet("mango/extend/swagger/pi/piContent/getWebSiteBaseInfo",params,rendomAboutUs)
}
getAboutUs();
//网站声明的回调函数
...
function getContactUs(currentPage){
    ...
    ajaxGet("mango/extend/swagger/pi/piContent/getWebSiteBaseInfo",params,rendomContactUs)
}
getContactUs();
//联系我们的回调函数
