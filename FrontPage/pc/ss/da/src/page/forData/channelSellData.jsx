...
export default class ChannelSellData extends Component {
    constructor(props) {
        super(props)
        this.state = {
            ...
            startTime:'',                               //  采集开始时间默认值
            endTime:'',                                 //  采集结束时间默认值
            saleChannelTypeText:'',                     //  销售渠道
            propsAjax: {
                name: 'file',
                action: api.BASEURL_01 + '/extend/swagger/da/daSaleChannel/importExcel',
                headers: {
                    ...
                    render: (text, record) => (
                        <span>
                            <Tooltip placement="bottom" title="审核">
                                <NavLink to={`/forData/channelSellData/channelSellDataAduit/${text}-${record.key}`}>
                                    <Icon 
                                        type="credit-card"
                             ...
                             <Tooltip placement="bottom" title="编辑">
                                <NavLink to={`/forData/channelSellData/channelSellDataAdd/${text}-${record.key}`}>
                                    <Icon
                                        type="form"
                                        style={{ padding: '0 4px', cursor: 'potainer' }}
                                    />
    ...
    delListFn = (delArr) =>{
        ...
        api.channelSellDelList.send(params).then(res=>{
            // console.log(res)
            if(res.isSuccess){
    ...
    confirmDel=(e)=>{
        // console.log(e);
        api.channelSellDel.send({id:e}).then(res=>{
            // console.log(res)
            if(res.isSuccess){
    ...
    initAltitudeList=(current)=>{
        ...
        api.channelSellList.send(params).then(res=>{
            console.log(res)
            let tableData=[];
            if(res.isSuccess){
            ...
            <div className="forData">
                ...
                {/* <li>
                    ...
                    <li>
                        ...
                        <Input data-type="saleChannelTypeText" onChange={this.getValue} style={{ width: '65%' }} defaultValue={saleChannelTypeText} />
                    </li>
                    {/* <li>
                ...
                <div className="btn-type">
                    <NavLink to="/forData/channelSellData/channelSellDataAdd/1"><Button icon="plus">单条数据填报</Button></NavLink>
