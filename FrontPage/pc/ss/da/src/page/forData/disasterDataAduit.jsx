...
export default class DisasterDataAduit extends Component {
    constructor(props){
        super(props)
        this.state = ({
    ...
    formSaveFn = () =>{
        ...
        let params = {
          ...
          api.disasterDataAudit.send(params).then(res=>{
            //   console.log(res)
              if(res.isSuccess){
            ...
            <div className="forData">
                <ul className="form-search form-aduit clearfix">
                    ...
                    <li>
                        ...
                        <span>{disasterTypeText}</span>
                    </li>
                    <li>
                        <label htmlFor="">受灾面积：</label>
                        <span>{disasterArea}{disasterAreaUnitText}</span>
                    </li>
                    <li>
                        <label htmlFor="">经济损失：</label>
                        <span>{disasterLose}{disasterLoseUnitText}</span>
                    </li>
                    <li>
