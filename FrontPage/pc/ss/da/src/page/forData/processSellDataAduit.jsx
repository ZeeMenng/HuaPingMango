...
export default class ProcessSellDataAduit extends Component {
    constructor(props){
        super(props)
        this.state = ({
    ...
    formSaveFn = () =>{
        ...
        let params = {
          ...
          api.processSellAudit.send(params).then(res=>{
            //   console.log(res)
              if(res.isSuccess){
            ...
            <div className="forData">
                ...
                {/* <li>
                    ...
                    <li>
                        ...
                        <span>{wasteAmount}{wasteAmountUnitText}</span>
                    </li>
                    <li>
