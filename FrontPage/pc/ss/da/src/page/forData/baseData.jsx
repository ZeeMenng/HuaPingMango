...
export default class BaseData extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            propsAjax: {
                name: 'file',
                action: api.BASEURL_01 + '/extend/swagger/da/daBaseInfo/importExcel',
                headers: {
                    ...
                    render: (text, record) => (
                        <span>
                            <Tooltip placement="bottom" title="审核">
                                <NavLink to={`/forData/baseData/baseDataAduit/${text}-${record.key}`}>
                                    <Icon 
                                        type="credit-card"
                             ...
                             <Tooltip placement="bottom" title="编辑">
                                <NavLink to={`/forData/baseData/baseDataAdd/${text}-${record.key}`}>
                                    <Icon
                                        type="form"
                                        style={{ padding: '0 4px', cursor: 'potainer' }}
                                    />
    ...
    delListFn = (delArr) =>{
        ...
        api.baseDataDelList.send(params).then(res=>{
            // console.log(res)
            if(res.isSuccess){
    ...
    confirmDel=(e)=>{
        // console.log(e);
        api.baseDataDel.send({id:e}).then(res=>{
            // console.log(res)
            if(res.isSuccess){
    ...
    initAltitudeList=(current)=>{
        ...
        api.baseDataList.send(params).then(res=>{
            console.log(res)
            let tableData=[];
            if(res.isSuccess){
            ...
            <div className="forData">
                <ul className="form-search clearfix">
                    ...
                    <li>
                        ...
                        <Input data-type="baseName" onChange={this.getValue} style={{ width: '65%' }} defaultValue={baseName} />
                    </li>
                    {/* <li>
                ...
                <div className="btn-type">
                    <NavLink to="/forData/baseData/baseDataAdd/1"><Button icon="plus">单条数据填报</Button></NavLink>
