...
export default class SellDataAduit extends Component {
    constructor(props){
        super(props)
        this.state = ({
    ...
    formSaveFn = () =>{
        ...
        let params = {
          ...
          console.log(params)
          api.framerSellAudit.send(params).then(res=>{
              console.log(res)
              if(res.isSuccess){
            ...
            <div className="forData">
                <ul className="form-search form-aduit clearfix">
                    ...
                    <li>
                        ...
                        <span>{tradeAmount}{tradeAmountUnitText}</span>
                    </li>
                    <li>
                        <label htmlFor="">交易额：</label>
                        <span>{tradeVolume}{tradeVolumeUnitText}</span>
                    </li>
                    <li>
