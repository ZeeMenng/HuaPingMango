...
$(document).ready(function () {
    ...
    var ajaxParamAdmin = {
        url: RU_GPDICTIONARY_GETLISTBYTYPEID + "/" + DI_MODULE
    };
    ...
    var pageParam = {
        ...
        editPage: {
            title: "批量修改表单",
            url: RP_GPMODULE_EDIT
        },
        detailPage: {
            url: RP_GPMODULE_DETAIL
        },
        addPage: {
            url: RP_GPMODULE_ADD
        },
        deleteInterface: {
            url: RU_GPMODULE_DELETE
        },
        deleteListInterface: {
            url: RU_GPMODULE_DELETELIST
        },
        exportExcelInterface: {
            url: RU_GPMODULE_EXPORTEXCEL
        }

    };
    var ajaxParam = {
        url: RU_GPMODULE_GETLISTBYJSONDATA,
        type: "GET",
        submitData: {
            "entityRelated": {},
            "orderList": [{
        ...
        columnInfo: [

            {
                ...
                "linkFunction": function (event) {
                    var href = RP_GPMODULE_DETAIL + "?" + RECORD_ID + "=" + event.id;
                    return href;
                },
            },
            {
    ...
    var operationParam = [{
        ...
        "clickFunction": function (event) {
            layer.confirm('您确定要删除当前记录？', {
                ...
                pageParam.deleteInterface.url = RU_GPMODULE_DELETE;
