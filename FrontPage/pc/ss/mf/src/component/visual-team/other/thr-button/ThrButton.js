...
export default class ThrButton extends React.Component{
  ...
  render(){
    return(
      <div>
        <ul style={{position:'absolute',zIndex:5,left:this.props.left||'0px',top:this.props.top||'0px',fontSize:'16px',width:'174px',/* 260px */height:'30px',lineHeight:'30px',background:'#0f50fb',border:'1px solid #1fb5fc',borderRadius:'30px'}}>
          {
            this.addList()
          }
        </ul>
