...
export default class PureBar extends Component {
  ...
  componentDidUpdate(){
    ...
    //console.log(this.state.data.legendName)
    let option = {
      title:{
        show:true,
            ...
            itemStyle: {
              normal: {
                color: {
                  ...
                  y2: 1,
                  colorStops: [{
                    offset: 0, color: 'rgba(250,250,150,1)'
                  }, {
                    offset: 1, color: 'rgba(250,250,150,0.3)'
                  }]
                },
                borderColor: {
                  type: 'linear',
    ...
    let arr1 = this.state.data.yData2;
    arr1.map((v,i)=>{
      if(i > arr1.length-4){
          ...
          itemStyle: {
            normal: {
              ...
              color: {
                ...
                y2: 1,
                colorStops: [{
                  offset: 0, color: 'rgba(250,250,150,0)'
                }, {
                  offset: 1, color: 'rgba(250,250,150,0)'
                }]
              },
              borderColor: {
                type: 'linear',
