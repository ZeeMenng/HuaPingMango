      ...
      option.series[0].data.push({
        ...
        itemStyle: {
          color: {
            ...
            y2: 1,
            colorStops: [{
              offset: 0, color: config.colorTop[i] || config.colorTop[config.colorTop.length - 1] // 0% 处的颜色
            }, {
              offset: 1, color: config.colorBottom[i] || config.colorBottom[config.colorBottom.length - 1]// 100% 处的颜色
            }],
