    ...
    return (
      <div>
        ...
        <Panel height={285} width={1720} left={'160px'} top={'755px'}>
          ...
          <p ref={'hurley1'} style={{display:'none',height:'16px',lineHeight:'16px',color:'#46ebff',position:'absolute',left:'135px',top:'25px',fontSize:'16px',width:'1500px'}}>结论：每斤价格为10-15元贵妃芒最受消费者青睐。果径为8-9cm，单价为5-15元/公斤的芒果最受消费者青睐。</p>
