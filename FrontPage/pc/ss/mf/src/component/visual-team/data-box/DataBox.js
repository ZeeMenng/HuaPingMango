        ...
        <div style={me.rightData}>
          ...
          <p style={{height: '53px',lineHeight:'53px',fontSize:'18px',color:'#46ebff',marginBottom:0}}>
            <span style={{width: '142px', height: '53px', float: 'left',textAlign:'right'}}>
              <Word num={(num / 1).toFixed(2)}color1={me.props.color1} color2={me.props.color2}/>
            </span>
            <span style={{width: '75px', height: '53px',lineHeight:'63px', float: 'right',textAlign:'left'}}>{this.props.unit}</span>
          </p>
        </div>
      </div>
    )
